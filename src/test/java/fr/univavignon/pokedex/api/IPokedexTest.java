...
public class IPokedexTest {
    ...
    public void testSize() {
        ...
        pokedex.addPokemon(new Pokemon(1, "Bulbasaur", 118, 118, 90, 500, 100, 100, 50, 80));
        pokedex.addPokemon(new Pokemon(2, "Ivysaur", 151, 151, 120, 800, 150, 150, 100, 85));
    ...
    public void testAddPokemon() {
        ...
        int index = pokedex.addPokemon(new Pokemon(1, "Bulbasaur", 118, 118, 90, 500, 100, 100, 50, 80));
